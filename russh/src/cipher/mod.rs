...
const MAXIMUM_CHANNEL_PACKET_LEN: usize = 256 * 1024;
// `packet_length` includes the SSH message framing and padding, so a full
// 256 KiB channel packet needs transport-layer headroom as well.
const MAXIMUM_PACKET_LEN_HEADROOM: usize = 32;
const MAXIMUM_PACKET_LEN: usize = MAXIMUM_CHANNEL_PACKET_LEN + MAXIMUM_PACKET_LEN_HEADROOM;
